...
#my $dbuser    ="****";            #ÔËĞĞ¸Ã½Å±¾µÄOracleÓÃ»§
#my $password  ="****";            #dbuserµÄÃÜÂë
#my $schema    ="****";            #µ¼ÈëOracleÊı¾İ¿âÓÃµÄschema
#my $dsn       ="****";            #¸ÃOracleÊı¾İ¿âµÄTNS
#$home         ="****";            #½Å±¾´æ·ÅÄ¿Â¼
...
#
##################################################################
open (CFILE,">$home/file/$table_name.ctl") or die "open file failed"; 
print CFILE "LOAD DATA \n";
print CFILE "CHARACTERSET ZHS16GBK\n";
...
print "The file now in the directory $home/file/ \n";
##################################################################
#
#  Éú³ÉsqlloaderÔËĞĞ½Å±¾
#
