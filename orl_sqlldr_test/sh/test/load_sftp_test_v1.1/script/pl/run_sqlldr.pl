...
my $loader="sqlldr userid=$dbuser/$password\@${dsn} control=${home}/load/script/${table_name}_temp.ctl  data=${home}/load/data/$filename  bad=${home}/load/data/$filename.bad log=${home}/load/log/$filename.log";
